...
// Sleeping cat with tail wag and Zzz animation. Designed for LIGHT theme only —
// uses dark ink on white background; won't read against dark surfaces.
export function CatLoader() {
  return (
    <div className={styles.loader} role="status" aria-label="Загрузка">
      <div className={styles.wrapper}>
        <div className={styles.catContainer}>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 733 673" className={styles.catbody}>
          ...
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 158 564" className={styles.tail}>
        ...
        <div className={styles.wallContainer}>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 500 126" className={styles.wall}>
            ...
            <line strokeWidth={6} stroke="#7C7C7C" y2={43} x2={500} y1={43} x1={0} />
            <line strokeWidth={6} stroke="#7C7C7C" y2="1.99391" x2="115.5" y1="43.0061" x1="115.5" />
            <line strokeWidth={6} stroke="#7C7C7C" y2={2} x2={189} y1="43.0122" x1={189} />
